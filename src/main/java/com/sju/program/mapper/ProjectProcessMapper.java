...
public interface ProjectProcessMapper
{
    ...
    List<ProjectProcess> selectProjectProcessByProjectName(@Param("id") Long id, @Param("projectName") String projectName);


    List<ProjectProcess> selectProjectProcessByProjectName02(@Param("projectName") String projectName);
