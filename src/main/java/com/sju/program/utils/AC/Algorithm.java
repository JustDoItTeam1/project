	...
	public static void query(AcNode root,String s){
		...
		for (int i = 0; i < s.length(); i++) {
			...
			if (temp.children.get(c[i])!=null){
				...
				continue;//如果temp的failnode为空，代表temp为root节点，没有在树中找到符合的敏感字，故跳出循环，检索下个字符
			}
