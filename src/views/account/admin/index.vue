<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <!--          :disabled="multiple"-->
      <!--          @click="handleDelete"-->
      <!--          v-hasPermi="['account:admin:remove']"-->
      <!--        >删除</el-button>-->
      <!--      </el-col>-->
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['account:admin:export']"
        >导出</el-button>
      </el-col>
...
<!--      <el-table-column label="账号" align="center" prop="adminId" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="用户账户" prop="adminUsername">
          <el-input v-model="form.adminUsername" placeholder="请输入用户账户" />
        </el-form-item>
        <el-form-item label="密码" prop="adminPassword">
          <el-input v-model="form.adminPassword" placeholder="请输入密码"show-password />
        </el-form-item>
      </el-form>
...
<script>
  import { listAdmin, getAdmin, delAdmin, addAdmin, updateAdmin, exportAdmin } from "@/api/account/admin";
  ...
  export default {
    ...
    methods: {
      ...
      handleDelete(row) {
        ...
        this.$confirm('是否确认删除管理员用户编号为"' + adminIds + '"的数据项?', "警告", {
      ...
      handleExport() {
        ...
        this.$confirm('是否确认导出所有管理员用户数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
