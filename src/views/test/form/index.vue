<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="testList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="出生日期" align="center" prop="date" width="180">
...
<script>
import { listTest, getTest, delTest, addTest, updateTest, exportTest } from "@/api/test/test";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除测试信息编号为"' + ids + '"的数据项?', "警告", {
